...
export default function Creategroup() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async () => {
            const create_response: any = await createGroupService(values, setAlert, setAlertMessage)
            window.location.href = configData.VIEW_GROUP_URL + create_response.data.Id
        },
    });
